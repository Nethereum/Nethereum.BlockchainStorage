...
CREATE INDEX [IX_Contracts_Name] ON [main].[Contracts] ([Name]);
...
CREATE UNIQUE INDEX [IX_TransactionLogs_TransactionHash_LogIndex] ON [main].[TransactionLogs] ([TransactionHash], [LogIndex]);
...
VALUES (N'20180817100322_InitialCreate', N'2.1.1-rtm-30846');
