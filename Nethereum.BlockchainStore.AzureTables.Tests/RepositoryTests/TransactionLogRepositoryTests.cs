...
namespace Nethereum.BlockchainStore.AzureTables.Tests.RepositoryTests
{
    ...
    {
        private readonly IAzureTableTransactionLogRepository _repo;

        public TransactionLogRepositoryTests(AzureTablesFixture fixture)
        {
            this._repo = fixture.Factory.CreateAzureTablesTransactionLogRepository();
        }
