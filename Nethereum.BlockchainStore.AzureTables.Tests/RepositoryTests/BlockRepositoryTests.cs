...
namespace Nethereum.BlockchainStore.AzureTables.Tests.RepositoryTests
{
    ...
    {
        private readonly IAzureTableBlockRepository _repo;

        public BlockRepositoryTests(AzureTablesFixture fixture)
        {
            this._repo = fixture.Factory.CreateAzureTablesBlockRepository();
        }
