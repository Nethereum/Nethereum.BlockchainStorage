...
namespace Nethereum.BlockchainStore.AzureTables.Tests.RepositoryTests
{
    ...
    {
        private readonly IAzureTableContractRepository _repo;

        public ContractRepositoryTests(AzureTablesFixture fixture)
        {
            this._repo = fixture.Factory.CreateAzureTablesContractRepository();
        }
