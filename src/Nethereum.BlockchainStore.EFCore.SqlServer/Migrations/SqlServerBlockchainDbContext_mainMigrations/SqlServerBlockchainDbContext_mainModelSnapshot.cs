...
namespace Nethereum.BlockchainStore.EFCore.SqlServer.Migrations.SqlServerBlockchainDbContext_mainMigrations
{
    ...
    partial class SqlServerBlockchainDbContext_mainModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Nethereum.BlockchainProcessing.BlockStorage.Entities.AddressTransaction", b =>
                {
                    ...
                    b.ToTable("AddressTransactions", "main");
                });
            ...
            modelBuilder.Entity("Nethereum.BlockchainProcessing.BlockStorage.Entities.TransactionVmStack", b =>
                {
                    ...
                    b.ToTable("TransactionLogVmStacks", "main");
                });
