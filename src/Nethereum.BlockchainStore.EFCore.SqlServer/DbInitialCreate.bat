...
dotnet ef migrations remove -f -c SqlServerBlockchainDbContext_goerli
dotnet ef migrations remove -f -c SqlServerBlockchainDbContext_sepolia
...
dotnet ef migrations add -c SqlServerBlockchainDbContext_goerli InitialCreate
dotnet ef migrations add -c SqlServerBlockchainDbContext_sepolia InitialCreate
...
dotnet ef database update -c SqlServerBlockchainDbContext_goerli
dotnet ef database update -c SqlServerBlockchainDbContext_sepolia