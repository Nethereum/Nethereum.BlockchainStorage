...
namespace Nethereum.BlockchainStore.EFCore.Tests.SqlServer
{
    public class TestSqlServerBlockchainDbContextFactory : SqlServerCoreBlockchainDbContextFactory
    {
        public const string ConnectionString =
            "Data Source=localhost\\SQLDEV;Database=BlockchainStorage;Integrated Security=False;User ID=blockchaindbo1;Password=bALLfMA1wBlJCzSGZhkO;Connect Timeout=60;";
